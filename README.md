...
* [NextLevel](https://github.com/nextlevel/NextLevel) ⭐ 2,330 | 🐛 12 | 🌐 Swift | 📅 2026-06-08 – Open Source ARKit Media Capture in Swift.
...
* [ARVideoKit](https://github.com/AFathi/ARVideoKit) ⭐ 1,652 | 🐛 56 | 🌐 Swift | 📅 2022-10-24 - Record and capture videos 📹, photos 🌄, Live Photos 🎇, and GIFs 🎆 with ARKit content.
...
* [iOS-Depth-Sampler](https://github.com/shu223/iOS-Depth-Sampler) ⭐ 1,219 | 🐛 8 | 🌐 Swift | 📅 2023-11-04 - A collection of samples for Depth APIs, including ARKit+Depth sample.
...
* [ARKit-line-drawing](https://github.com/lapfelix/ARKit-line-drawing) ⭐ 408 | 🐛 3 | 🌐 Swift | 📅 2017-08-25 - Changed the default ARKit project to draw a line where the camera is positioned
...
* [pARtfolio](https://github.com/rosberry/pARtfolio) ⭐ 32 | 🐛 0 | 🌐 Swift | 📅 2018-09-07 - Rosberry Portfolio app made with Apple ARKit.
* [ARKitAirport](https://github.com/chriswebb09/ARKitAirport) ⭐ 30 | 🐛 0 | 🌐 Swift | 📅 2023-01-09 - Tap on map, plane will take off from an AR runway and fly to location you tapped.
* [cARd](https://github.com/artemnovichkov/cARd) ⭐ 29 | 🐛 0 | 🌐 Swift | 📅 2017-09-04 - Simple demo of animated card made with ARKit + SceneKit.
* [MarvelAR](https://github.com/hadiidbouk/MarvelAR) ⭐ 26 | 🐛 0 | 🌐 Swift | 📅 2019-06-16 - MarvelAR is an iOS application that present Marvel Heroes 3D Models Using ARKit.
* [ARInvaders](https://github.com/aivantg/ar-invaders) ⭐ 24 | 🐛 0 | 🌐 Swift | 📅 2018-10-09 - A port of Space Invaders using ARKit. Aliens will fly and chase you around your home. Can you shoot them before they shoot you?
* [ARCarGuidePoC](https://github.com/eldare/ARCarGuidePoC) ⭐ 24 | 🐛 0 | 🌐 Swift | 📅 2020-11-11 - Detects parts under a hood of a motor vehicle, and tracks the detected parts in AR.
* [ARBalloons](https://github.com/nagam11/ARBalloons) ⭐ 23 | 🐛 0 | 🌐 Swift | 📅 2017-08-29 - Sample ARKit Demo using SpriteKit to simulate balloons🎈
* [AR-Quick-Look](https://github.com/anand2nigam/AR-Quick-Look) ⭐ 23 | 🐛 0 | 🌐 Swift | 📅 2020-10-03 - Rendering any 3d model in Augmented Reality using AR-Quick-Look, recently launched by Apple to view or share your 3d model.
...
* [AR Sections](https://github.com/Rageeni/AR-Sections) ⭐ 5 | 🐛 1 | 🌐 Swift | 📅 2018-07-27
  ...
  3. Draw Planets
  4. AR Hit Game
* [Blood cells AR](https://github.com/andrelucassvt/Blood-Cells-AR) ⭐ 1 | 🐛 0 | 🌐 Swift | 📅 2024-02-08 - discover cells in augmented reality(Using Ar Quick look)
